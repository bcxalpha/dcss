...
- Hanya preset `Medium`, dengan numeric VM yang dioptimalkan untuk LuaU/Roblox.
...
`Medium` adalah satu-satunya preset. Profil ini mempertahankan numeric VM, encrypted operands/constants, instruction cache, integrity verification sekali per prototype, dan opcode polymorphism ringan, dengan noise serta wrapper overhead yang ditekan untuk menjaga ukuran dan runtime tetap masuk akal.
