...
Vmify.SettingsDescriptor = {
    ...
    OpcodeVariants = {
        ...
        min = 2,
        max = 4,
        description = "Number of polymorphic opcode aliases emitted per handler. Lower values reduce output size while keeping alias randomization.",
    },
    HandlerWrapperNoise = {
        type = "boolean",
        default = false,
...
function Vmify:apply(ast, pipeline)
	...
	local compiler = Compiler:new(pipeline and pipeline.LuaVersion, {
        ...
        OpcodeVariants = self.OpcodeVariants,
