...
function R.emit(protos, constants, luaVersion, options)
    ...
    local opcodeVariants = math.floor(tonumber(options.OpcodeVariants or options.opcodeVariants) or 3)
    if opcodeVariants < 2 then opcodeVariants = 2 end
    if opcodeVariants > 4 then opcodeVariants = 4 end
